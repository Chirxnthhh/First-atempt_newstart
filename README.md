...
- Dynamic global symbol discovery for stocks, futures, forex, crypto, indices, and ETFs with search, category/exchange filters, pagination, and watchlist favorites.
